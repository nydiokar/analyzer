...
1.  **Implement `GET /wallets/{walletAddress}/aggregated-metrics` API Endpoint:** Develop the endpoint to provide comprehensive metrics from the latest `AdvancedStatsResult` for a wallet. (Corresponds to plan section 4.3.3)
2.  **Implement `GET /wallets/{walletAddress}/pnl-overview` API Endpoint:** Develop the endpoint to provide a top-level PNL overview, potentially drawing from `PnlAnalysisService`. (New, as discussed)
...
1.  **`GET /wallets/{walletAddress}/token-performance`**:
...
2.  **`GET /wallets/{walletAddress}/aggregated-metrics`**:
...
-   **`GET /wallets/{walletAddress}//token-performance`**: (Moved to "Next Endpoints to Implement")

#### 4.3.3 Aggregated Metrics View Endpoints
-   **`GET /wallets/{walletAddress}/aggregated-metrics`**: (Moved to "Next Endpoints to Implement")

#### 4.3.4 Behavior View Endpoints
-   **`GET /wallets/{walletAddress}//behavior-analysis`**:
