...
| C4          | **Frontend Job Trigger Hook**     | C2             | ✅ **COMPLETE** | "Implement frontend call to `POST /jobs/similarity/analyze`. Store returned job ID, subscribe via polling or WebSocket. Replace old similarity flow trigger." |
