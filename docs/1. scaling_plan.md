...
1.  **Deploy Dashboard & Backend (Initial Self-Hosted Version):**
    *   **Goal:** Make the current version of the dashboard and its backend API publicly accessible for testing and initial use. This includes configuring the Nginx reverse proxy with SSL and Layer 1 rate limiting.
    *   **Status:** `To Do`
