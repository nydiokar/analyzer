...
5.  **API & Dashboard Enhancements (Considered for a near-future iteration, post-backend implementation):**
    ...
    *   **Dashboard Integration:**
        ...
        *   The "Account Stats & PNL" tab will continue to show the "Current Holdings Snapshot" section as generated by the `PnlAnalysisService` and included in the PNL report / `/summary` endpoint, providing a full list of all balances at the time of analysis.
