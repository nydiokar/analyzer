...
import { DatabaseService } from '../database/database.service'; // NestJS-wrapped DatabaseService
...
export class PnlAnalysisService {
  ...
  constructor(
    ...
    this.corePnlAnalysisService = new CorePnlAnalysisService(this.databaseService, this.heliusApiClient);
