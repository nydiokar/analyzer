/*
  ...
  - You are about to drop the column `direction` on the `SwapAnalysisInput` table. All the data in the column will be lost.
  - You are about to drop the column `solReceivedInTx` on the `SwapAnalysisInput` table. All the data in the column will be lost.
  - You are about to drop the column `solSpentInTx` on the `SwapAnalysisInput` table. All the data in the column will be lost.
